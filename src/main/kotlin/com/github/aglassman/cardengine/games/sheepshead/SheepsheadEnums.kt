...
enum class Action(
  ...
  beginPlay({"Kick off the first trick of the hand."}),
  ...
  callAce({
    "After a blind pick, the picker can choose to call a partner by picking a fail suit. " +
      "The picker must have at least one of that fail suit. " +
      "The player that holds the Ace of the called suit will be the partner."
  }, ParamType.Str)
}
